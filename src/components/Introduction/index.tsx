...
const Introduction = () => {
	...
	return (
		<div className="w-full md:pt-40 pt-28 md:px-24 px-5 flex md:flex-row flex-col items-center md:justify-around justify-center md:gap-24 gap-10">
			<div className="flex items-center gap-4 md:w-[60%] w-full md:justify-normal justify-center">
			...
			<div className="flex flex-col gap-5 md:w-[40%] w-full">
				<span className="font-bold md:text-[75px] text-[50px] max-w-[600px] md:leading-[90px] leading-[70px]">
